...
public class ArmoryMaterialInitializer {
    ...
    public void onAPICallbackReceived(IArmoryAPI api) {
        ...
        ardite.setTranslationKey(TinkerMaterials.ardite.getLocalizedName());
        cobalt.setTranslationKey(TinkerMaterials.cobalt.getLocalizedName());
        manyullun.setTranslationKey(TinkerMaterials.manyullyn.getLocalizedName());

        if (Weaponry.side == Side.CLIENT) {
            ardite.setRenderInfo(new ConversionRenderInfo(TinkerMaterials.ardite.renderInfo));
            cobalt.setRenderInfo(new ConversionRenderInfo(TinkerMaterials.cobalt.renderInfo));
            manyullun.setRenderInfo(new ConversionRenderInfo(TinkerMaterials.manyullyn.renderInfo));
        }
    ...
    private boolean checkIfRegisterIsNeededForRecipe(CastingRecipe recipe)
    {
        ...
        for (int oreId : oreIds)
        {
            ...
            {
                String metalName = OreDictionary.getOreName(oreId).replace("ingot", "").toLowerCase();
                ...
                autoGeneratedMaterial.setRenderInfo(new ConversionRenderInfo(material.renderInfo));
